import { Cloud, Monitor, Bot, Beaker, Terminal, Zap, Trophy, Target, BarChart3 } from 'lucide-react'
    ...
    return (
        <section className="py-16 px-4 bg-gradient-to-br from-cyan-900 via-blue-900 to-slate-900 overflow-hidden">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Three cards in a responsive grid – no horizontal scroll */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div className="group h-full">
                        <div className="bg-white/5 backdrop-blur-sm border border-white/20 rounded-2xl overflow-hidden shadow-2xl 
                                        transition-all duration-500 hover:shadow-cyan-500/20 hover:border-cyan-400/50 h-full flex flex-col">
                    ...
                    <div className="group h-full">
                        <div className="bg-white/5 backdrop-blur-sm border border-white/20 rounded-2xl overflow-hidden shadow-2xl 
                                        transition-all duration-500 hover:shadow-blue-500/20 hover:border-blue-400/50 h-full flex flex-col">
                            <div className="relative overflow-hidden">
                                <img
                                    src={labsImg}
                                    alt="Hands-on Labs"
